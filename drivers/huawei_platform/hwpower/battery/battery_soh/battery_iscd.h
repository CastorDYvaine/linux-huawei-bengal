...
#define ISCD_OCV_LOW_VALID_THRESHOLD   4000000
#define ISCD_OCV_HIGH_VALID_THRESHOLD  4600000
#define ISCD_CUR_VALID_THRESHOLD       20
...
struct iscd_device_info {
	...
	struct notifier_block thirdplat_event_nb;
	struct notifier_block chg_event_nb;
	struct notifier_block event_nb;
	struct psy_bat_param iscd_psy_param;
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 10, 0))
