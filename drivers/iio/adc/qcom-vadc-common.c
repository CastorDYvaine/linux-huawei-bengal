...
#ifdef CONFIG_SUPPORT_USBPORT_30K_PULLUP
static const struct vadc_map_pt adcmap_30k_104ef_104fb_1875_vref[] = {
	{ 1618000,	-40000 },
	{ 1552000,	-35000 },
	{ 1477000,	-30000 },
	{ 1392000,	-25000 },
...
#ifdef CONFIG_HUAWEI_POWER_EMBEDDED_ISOLATION
#ifdef CONFIG_SUPPORT_USBPORT_30K_PULLUP
static int qcom_vadc_scale_hw_calib_therm_30(
				const struct vadc_prescale_ratio *prescale,
				const struct adc_data *data,
				u16 adc_code, int *result_mdec)
{
	...
	voltage = div64_s64(voltage, (data->full_scale_code_volt
								* 1000));
	ret = qcom_vadc_map_voltage_temp(adcmap_30k_104ef_104fb_1875_vref,
				 ARRAY_SIZE(adcmap_30k_104ef_104fb_1875_vref),
				 voltage, &result);
	if (ret)
		return ret;
		    ...
		    u16 adc_code, int *result)
{
	...
	case SCALE_HW_CALIB_DEFAULT:
		return qcom_vadc_scale_hw_calib_volt(prescale, data, adc_code, result);
	case SCALE_HW_CALIB_THERM_100K_PULLUP:
	case SCALE_HW_CALIB_XOTHERM:
		return qcom_vadc_scale_hw_calib_therm(prescale, data, adc_code, result);
#ifdef CONFIG_HUAWEI_POWER_EMBEDDED_ISOLATION
#ifdef CONFIG_SUPPORT_USBPORT_30K_PULLUP
	case SCALE_HW_CALIB_THERM_30K_PULLUP:
		return qcom_vadc_scale_hw_calib_therm_30(prescale, data, adc_code, result);
#endif
#endif
