 ...
 * ufshcd_mas_extend.c
 *
 * The mas extend implements for ufshcd.c
 *
...
int mas_ufs_get_device_info(struct ufs_hba *hba,
...
{
	u64 tr_doobell;
#ifdef CONFIG_MAS_UFS_HC_CORE_UTR
