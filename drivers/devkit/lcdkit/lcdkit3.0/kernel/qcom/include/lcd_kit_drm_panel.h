...
enum display_idle_mode_type {
	DISPLAY_IDLE_OFF = 0,
	DISPLAY_IDLE_DOZE = 1,
	DISPLAY_IDLE_ON = 2,
	DISPLAT_IDLE_DOZE_SUSPEND = 3,
	DISPLAY_IDLE_ON_SUSPEND = 4,
	DISPLAY_IDLE_PROX_OFF = 122,
};
