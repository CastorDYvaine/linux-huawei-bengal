...
#define BAT_CYC_INIT_MAX_RETRY			120
#define BAT_CYC_INIT_SN_MAX_RETRY		100
#define BAT_CYC_UNIT				100

enum bat_cycle_ft_remind_mode {
	BAT_CYC_FT_REMIND_MODE_BATT_REMOVED_NOCT	= 0,
	BAT_CYC_FT_REMIND_MODE_BATT_REMOVED		= 1,
	BAT_CYC_FT_REMIND_MODE_ALWAYS			= 2,
};
...
enum bat_cycle_sn_retry_mode {
	BAT_CYC_SN_RETRY_MODE_NEVER		= 0,
	BAT_CYC_SN_RETYR_MODE_NORMAL		= 1,
	BAT_CYC_SN_RETYR_MODE_ALWAYS		= 2,
};
