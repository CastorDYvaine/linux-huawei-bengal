...
static int rt9426_get_display_data(struct rt9426_chip *chip, int index);
	...
	struct rt9426_fc_setting *fc_setting)
{
	...
	fc_setting->fc_th = (fc_setting->fc_th & POWER_MASK_BYTE) | ((chip->pdata->fc_ith & POWER_MASK_BYTE) << 8);
...
static void rt9426_fc_vth_low_curr_adjust(struct rt9426_chip *chip,
	struct buck_ffc_charge_info *ndata, struct rt9426_fc_setting *fc_setting)
{
...
static void rt9426_dynamic_change_term_setting(struct rt9426_chip *chip,
	struct buck_ffc_charge_info *ndata)
{
	struct rt9426_fc_setting fc_setting;
...
static void rt9426_adjust_fcc_learning_rate(struct rt9426_chip *chip)
{
	...
	cycle = (int)rt9426_get_cyccnt(chip);
...
static void rt9426_parse_iterm_setting(struct device *dev, struct device_node *np,
	struct rt9426_platform_data *pdata)
{
	if (pdata->thirdparty_ffc_buck_para_flag)
		(void)power_dts_read_str2int(power_dts_tag(HWLOG_TAG), np, "rt,ffc_buck_para_A",
	...
	const struct i2c_device_id *id)
{
	...
	chip->event_nb.notifier_call = rt9426_event_notifier_call;
