			     ...
			     size_t count, loff_t *ppos)
{
	...
	tmp_vip = static_vip & AVAILABLE_VIP;
	task->static_vip = (tmp_vip != 0) ? tmp_vip : 0;
#ifdef CONFIG_HW_GRADED_SCHED
	update_graded_nice(task, (bool)task->static_vip);
#endif
...
#endif
#ifdef CONFIG_HW_VIP_THREAD
	REG("static_vip", S_IRUGO | S_IWUGO | S_IWUSR, proc_static_vip_operations),
#endif
#ifdef CONFIG_ACCESS_TOKENID
	ONE("tokenid", S_IRUSR, proc_token_operations),
#endif
