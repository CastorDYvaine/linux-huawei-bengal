...
/**
 * struct brightness_info - udals brightness info structure
 * @mipi_level: mipi level
 * @bl_level: backlight level
 * @brightness_mode: backlight brightness mode
 */
...
/**
 * send brightness data to ambient light
 */
#define DRM_EVENT_BRIGHTNESS_INFO 0x80000100
#endif /* _SDE_DRM_H_ */
