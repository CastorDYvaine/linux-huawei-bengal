...
struct smartpa_afe_interface hw_afe_interface = {
	...
	.voice_set_customize_param = hw_voice_set_customize_param,
	.voice_get_customize_param = hw_voice_get_customize_param,
};
...
int hw_voice_set_customize_param(uint32_t module_id, uint32_t param_id,
                                                            uint32_t param_size, uint8_t *param_data)
{
	return voice_pack_and_set_customize_param(module_id, param_id, param_size, param_data);
}
EXPORT_SYMBOL_GPL(hw_voice_set_customize_param);

int hw_voice_get_customize_param(uint32_t module_id, uint32_t param_id,
                                                            uint32_t param_size, uint8_t *param_data)
{
	return voice_pack_and_get_customize_param(module_id, param_id, param_size, param_data);
}
EXPORT_SYMBOL_GPL(hw_voice_get_customize_param);
