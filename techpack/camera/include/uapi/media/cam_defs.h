...
#define CAM_DUMP_CUSTOMER                   (CAM_COMMON_OPCODE_BASE_v2 + 0xC) /* customer dump reg when sof freeze */
...
struct cam_dump_reg_info {  /* reference struct CamDumpRegInfo */
	unsigned short reg_addr;
	unsigned short addr_type; /* reference I2CRegAddressDataType, camera_sensor_i2c_type */
	unsigned short data_type; /* reference I2CRegAddressDataType, camera_sensor_i2c_type */
