...
enum cam_sensor_otp_type {
	CAM_SENSOR_OTP_NONE,
	CAM_SENSOR_OTP_HYNIX
};
...
struct i2c_data_settings {
	...
	struct i2c_settings_array deinit_settings;
};
...
enum cam_sensor_hiz_type_t {
	CAM_HIZ_NOT_NEED,
	CAM_HIZ_CONTROL_RST,
	CAM_HIZ_WRITE_I2C,
	CAM_HIZ_WRITE_I2C_DEBUG,
	CAM_HIZ_MAX,
};

struct cam_sensor_hiz_info {
	uint32_t hiz_type;
	struct cam_sensor_power_ctrl_t hiz_power_info;
	struct i2c_settings_array hiz_settings;
};
