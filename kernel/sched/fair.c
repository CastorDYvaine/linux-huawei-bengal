...
#if defined(CONFIG_HW_RTG_BOOST) || defined(CONFIG_HW_CPU_FREQ_GOV_SCHEDUTIL)
...
{
	return topology_get_cpu_scale(NULL, cpu) == SCHED_CAPACITY_SCALE;
}
...
#if defined(CONFIG_HW_EAS_SYSFS) || defined(CONFIG_HW_EAS_SCHED)
